...
class DeviceTypeData {    
    ...
    static let fourColorArray: [UIColor]! = [UIColor.red, UIColor.red, UIColor.red, UIColor.red]
    static let fourColorTitleArray: [String]! = ["Channel One", "Channel Two", "Channel Three", "Channel Four"]
    static let fiveColorArray: [UIColor]! = [UIColor.red, UIColor.red, UIColor.red, UIColor.red, UIColor.red]
